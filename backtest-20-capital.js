...
// CONFIGURACIÓN "MICRO" (Para capital de $20)
const CONFIG = {
    stake: 10,          // Bajamos stake para dar "vidas" a la cuenta
    takeProfit: 3.0,    // Meta intacta
    multiplier: 40,
    momentum: 5,
    stopLoss: 1.5,      // Riesgo intacto
    trailStart: 0.5,
    trailDist: 0.5,
    smaLongPeriod: 200
};
...
ws.on('open', () => {
    console.log(`📥 Descargando DATA TICKS para Backtest de 24H (STAKE $10)...`);
    fetchTicks();
});
...
function runSimulation() {
    ...
    console.log("=========================================");
    console.log("🏆 RESULTADO 24H (STAKE $10)");
    console.log("=========================================");
    console.log(`Total Trades: ${trades}`);
    console.log(`Ganadas: ${wins} ✅ | Perdidas: ${losses} ❌`);
    console.log(`PnL Neto Diario: $${balance.toFixed(2)} 💰`);
    console.log(`Crecimiento Cuenta $20: +${((balance / 20) * 100).toFixed(1)}%`);
    console.log("=========================================");
}
