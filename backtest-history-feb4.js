...
// FECHA OBJETIVO: 4 de Febrero de 2026
const startEpoch = Math.floor(new Date('2026-02-04T00:00:00Z').getTime() / 1000);
const endEpoch = Math.floor(new Date('2026-02-05T00:00:00Z').getTime() / 1000);
...
ws.on('open', () => {
    console.log(`📥 Descargando DATA TICKS para el 4 DE FEBRERO de 2026...`);
...
ws.on('message', (data) => {
    ...
    if (msg.msg_type === 'history') {
        ...
        if (times[0] > (startEpoch - 3600) && chunk.length > 0 && allTicks.length < 120000) {
...
function runSimulation() {
    ...
    console.log(`\n📊 SIMULANDO 24 HORAS del 4 DE FEBRERO...`);
    ...
    console.log("=========================================");
    console.log("🏆 RESULTADO FEB 4, 2026 (24H)");
    console.log("=========================================");
