...
let allTicks = [];
const TOTAL_TICKS_NEEDED = 25000; // ~6 Horas
...
ws.on('open', () => {
    console.log(`📥 Descargando DATA TICKS para DESGLOSE HORARIO (6 HORAS)...`);
    fetchTicks();
});
...
function runSimulation() {
    let globalBalance = 0;
    const ticksPerHour = Math.floor(allTicks.length / 6);

    console.log(`\n====================================================`);
    console.log(`📊 DESGLOSE HORA POR HORA (ÚLTIMAS 6H)`);
    console.log(`====================================================`);
    ...
    for (let h = 0; h < 6; h++) {
        ...
        console.log(`H${h + 1}   | ${hTrades.toString().padStart(6)} | ${hWins.toString().padStart(4)} | ${hLosses.toString().padStart(4)} | $${hBalance.toFixed(2).padStart(8)} | $${globalBalance.toFixed(2).padStart(8)}`);
    }
    console.log(`----------------------------------------------------`);
    console.log(`PNL FINAL 6 HORAS: $${globalBalance.toFixed(2)}`);
    console.log(`====================================================`);
}
