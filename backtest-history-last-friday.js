...
// FECHA OBJETIVO: Viernes pasado (27 de Febrero de 2026)
const startEpoch = Math.floor(new Date('2026-02-27T00:00:00Z').getTime() / 1000);
const endEpoch = Math.floor(new Date('2026-02-28T00:00:00Z').getTime() / 1000);
...
ws.on('open', () => {
    console.log(`📥 Descargando DATA TICKS para el VIERNES 27 DE FEBRERO de 2026...`);
...
ws.on('message', (data) => {
    ...
    if (msg.msg_type === 'history') {
        ...
        // Colchón de 1 hora antes (3600s) para SMA200
        if (times[0] > (startEpoch - 3600) && chunk.length > 0 && allTicks.length < 150000) {
...
function runSimulation() {
    ...
    console.log(`\n📊 SIMULANDO 24 HORAS del VIERNES 27 DE FEB...`);
    ...
    console.log("=========================================");
    console.log("🏆 RESULTADO FEB 27, 2026 (VIERNES)");
    console.log("=========================================");
