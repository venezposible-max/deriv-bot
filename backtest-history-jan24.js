...
// FECHA OBJETIVO: 24 de Enero de 2026
const startEpoch = Math.floor(new Date('2026-01-24T00:00:00Z').getTime() / 1000);
const endEpoch = Math.floor(new Date('2026-01-25T00:00:00Z').getTime() / 1000);
...
ws.on('open', () => {
    console.log(`📥 Descargando DATA TICKS para el 24 DE ENERO de 2026...`);
...
ws.on('message', (data) => {
    ...
    if (msg.msg_type === 'history') {
        ...
        // Colchón de 1 hora antes (3600s) para asegurar que el SMA200 esté listo
...
function runSimulation() {
    ...
    console.log(`\n📊 SIMULANDO 24 HORAS del 24 DE ENERO...`);
    ...
    console.log("=========================================");
    console.log("🏆 RESULTADO ENE 24, 2026 (24H)");
    console.log("=========================================");
