...
// Jan 24, 2026 23:59:59 GMT (para ir hacia atrás 24h)
const END_EPOCH = 1737763199;
...
ws.on('open', () => {
    console.log(`📥 Descargando DATA TICKS del 24 DE ENERO para REPORTE HORARIO...`);
    fetchTicks(END_EPOCH);
});
...
ws.on('message', (data) => {
    ...
    if (msg.msg_type === 'history') {
        ...
        if (allTicks.length < TOTAL_TICKS_NEEDED && chunk.length > 0) {
            ...
            console.log(`\n✅ DATA CARGADA (24 ENE): ${allTicks.length} ticks.`);
            runSimulation();
            ws.close();
        }
    }
...
function runSimulation() {
    ...
    console.log(`\n====================================================`);
    console.log(`📊 ESTRATEGIA AMETRALLADORA: 24 DE ENERO (DETALLE)`);
    console.log(`====================================================`);
    ...
    console.log(`----------------------------------------------------`);
    console.log(`PNL FINAL 24 ENERO: $${globalBalance.toFixed(2)}`);
    console.log(`====================================================`);
}
