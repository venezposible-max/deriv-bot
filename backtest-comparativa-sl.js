...
function runAnalysis(ticks) {
    console.log(`\n🕵️ ANÁLISIS: EL PUNTO MEDIO - STOP LOSS DE $3.00`);
    console.log(`==========================================================`);
    console.log(`Periodo: 1 Semana | Ticks: ${ticks.length}`);

    // Configuración: TP 0.6, M7
    test("HÍBRIDO PROTEGIDO (SL 0.6 | TP 0.6)", ticks, 0.60, 0.60, 7);
    test("PUNTO MEDIO (SL 3.0 | TP 0.6)", ticks, 0.60, 3.00, 7);
    test("A TODO O NADA (SL 10.0 | TP 0.6)", ticks, 0.60, 10.00, 7);
}
